    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'group' => 'payment',
                'type' => 'string',
                'label' => 'Flutterwave Public Key (starts with FLWPUBK-)',
                'description' => 'Public API key for Flutterwave V3.',
            ],
            [
                ...
                'group' => 'payment',
                'type' => 'encrypted_string',
                'label' => 'Flutterwave Secret Key (starts with FLWSECK-)',
                'description' => 'Secret API key for Flutterwave V3.',
            ],
            [
