...
export default function Terms() {
    ...
    const content = settings.terms_service_content;
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
            <div className="bg-white rounded-3xl border border-[#E5E7EB] shadow-sm overflow-hidden p-8 md:p-12">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h1 className="text-3xl font-black text-[#1A1A1A] tracking-tight">Terms of Service</h1>
                </div>
                ...
                <div 
                    ...
                    dangerouslySetInnerHTML={{ __html: content || '<p>Terms of service content is currently being updated. Please check back soon.</p>' }}
                />
