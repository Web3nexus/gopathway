    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'group' => 'payment',
                'type' => 'string',
                'label' => 'Flutterwave Client ID (V4)',
                'description' => 'Client ID for Flutterwave V4 API.',
            ],
            [
                ...
                'group' => 'payment',
                'type' => 'encrypted_string',
                'label' => 'Flutterwave Client Secret (V4)',
                'description' => 'Client Secret for Flutterwave V4 API.',
            ],
            [
